...
class M_pakan_view extends CI_Model { 
	
	//nama tabel
	var $table = 't_pakan'; 

	//kolom yang di tampilkan
	var $column_order = array(null,'pakan_id','pakan_kode'); 

	//kolom yang di tampilkan setelah seacrh
	var $column_search = array('pakan_nama','pakan_kode'); 

	//urutan 
	var $order = array('pakan_tanggal' => 'desc'); 
